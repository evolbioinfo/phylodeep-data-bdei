...
TARGET_NAMES = ["R_naught", "Infectious_period", "Incubation_period", 'sampling_proba', 'tree_size']

PREDICTED_NAMES = ["R_naught", "Infectious_period", "Incubation_period"]
...
def main():
    """
    Entry point, calling :py:func:`phylodeep_data_bdei.get_ci_table_paths`  with command-line arguments.
    :return: void
    """
    import argparse
